		...
		public void run() {
			ThreadPool.logThreadLifeCycle("ModifiedLinearOpMode main", () -> {
				...
				try {
					...
					RobotLog.d("ModifiedLinearOpMode received an InterruptedException; shutting down this Driving op " +
							"mode");
				} catch (CancellationException ie) {
					RobotLog.d("ModifiedLinearOpMode received a CancellationException; shutting down this Driving op " +
							"mode");
