...
import static org.firstinspires.ftc.teamcode.RoverRuckus.Constants.DEFAULT_MAX_ACCELERATION;
...
public class MecanumDriveBetter extends TaskProgram {
		...
		moveController = new AutoMoveController(robot,
		                                        ...
		                                        new RampedMoveController(
				                                        new Magnitudes(
						                                        ...
						                                        this.parameters.maxAngularAcceleration)));
	 ...
	 * rotation.
	 */
	class PositioningTask extends TaskAdapter {
	...
	public class MoveTaskBuilder {
		...
		private Task build(boolean fine) {
			...
			int consecutive =
					fine ? parameters.consecutiveFine : parameters.consecutiveCoarse;
			return new CompositeTask(
					new ChangeTargetPositionTask(toMove),
					new PositioningTask(maxTranslationSpeed,
					                    translationalTolerance,
	...
	public static class Parameters implements Cloneable {
		...
		public double  maxAngularAcceleration       = DEFAULT_MAX_ACCELERATION;
		public double  maxTranslationalAcceleration = DEFAULT_MAX_ACCELERATION;
